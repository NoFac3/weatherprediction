function [trainedModel, validationRMSE] = weatherGPRrq(trainingData)
...
% Auto-generated by MATLAB on 17-Jun-2022 18:49:39
...
predictorNames = {'ACMH', 'ACSH', 'PGTM', 'PRCP', 'PSUN', 'SNOW', 'SNWD', 'TMIN', 'TSUN', 'WDFG', 'WDFM', 'WSFG', 'WSFM'};
predictors = inputTable(:, predictorNames);
response = inputTable.TMAX;
...
trainedModel.RequiredVariables = {'ACMH', 'ACSH', 'PGTM', 'PRCP', 'PSUN', 'SNOW', 'SNWD', 'TMIN', 'TSUN', 'WDFG', 'WDFM', 'WSFG', 'WSFM'};
